...
const Mutations = {
  ...
  async resetPassword(parent, args, ctx, info) {
    ...
    // 5. Save new pass & remove older resetTokenfileds
  ...
  async addToCart(parent, args, ctx, info) {
    ...
    // 3. Check if the item is already in their cart and increment
    if (existingCartItem) {
    ...
    // 4. If itsw not create a fresh item for that user
